...
!============================================================================
 ...
 260       continue
	...
	logical function inseason(date1,date2,date)
	implicit none 
C	returns .True. if date is within the season, defined by 
C	the first day date1 and the last day date2
	integer date1,date2,date
